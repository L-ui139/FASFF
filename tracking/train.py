...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, help='training script name',default="tbsi_track")
    parser.add_argument('--config', type=str, default='vitb_256_tbsi_32x4_4e4_lasher_15ep_in1k', help='yaml configure file name')
    parser.add_argument('--save_dir', type=str, help='root directory to save checkpoints, logs, and tensorboard',default="/root/shared-nvme/output/vitb_256_tbsi_32x4_4e4_lasher_15ep_in1k")
